...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImageContainer.classList.add("col-md-6");  // change style width to use bootstrap framework
  ...
  pizzaDescriptionContainer.classList.add("col-md-6");  // change style width to use bootstrap framework
...
var resizePizzas = function(size) {
  ...
  // removed determine dx. man that was a performance hog!

  // Iterates through pizza elements on the page and changes their widths
  function changePizzaSizes(size) {
    // Using switch(size) from above (with some modifications) we can determine
    // width using % of image value
    var newwidth;
    switch(size) {
      case "1":
        newwidth = 25;
...
// Moved out of for loop. No need to keep getting the Element
